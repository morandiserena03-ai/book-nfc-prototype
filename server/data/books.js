module.exports = {
  book1: {
    ...
    coverImage: "Jane Eyre.png",
    genres: ["rosa", "storico"],
    narrativeStyles: ["Gotico", "Drammatico"],
    topic: ["Identita", "Amore", "Indipendenza", "Classe sociale", "Educazione", "Fede", "Autodeterminazione"],
    plot: ["Orfana", "Collegio", "Governante", "Segreto familiare", "Matrimonio interrotto", "Eredita", "Ritorno"],
    protagonists: ["Donna giovane", "Governante", "Orfana", "Uomo aristocratico", "Donna reclusa"],
    characters: ["Jane Eyre", "Edward Rochester", "Bertha Mason", "St. John Rivers", "Helen Burns", "Mrs Reed"],
    temporalSetting: "Ottocento",
    geographicSetting: "Inghilterra",
    moral: ["Dignità personale", "Libertà interiore", "Amore senza sottomissione", "Fedeltà a se stessi"]
  },

  book2: {
    title: "Cime tempestose",
    author: "Emily Brontë",
    coverImage: "Cime tempestose.png",
    genres: ["rosa", "storico"],
    narrativeStyles: ["Gotico", "Drammatico"],
    topic: ["Amore ossessivo", "Vendetta", "Classe sociale", "Famiglia", "Eredita", "Natura selvaggia"],
    plot: ["Adozione", "Passione proibita", "Matrimonio infelice", "Rancore", "Vendetta", "Riconciliazione"],
    protagonists: ["Uomo emarginato", "Donna ribelle", "Famiglia aristocratica", "Eredi"],
    characters: ["Heathcliff", "Catherine Earnshaw", "Edgar Linton", "Nelly Dean", "Hindley Earnshaw", "Cathy Linton"],
    temporalSetting: "Ottocento",
    geographicSetting: ["Yorkshire", "Inghilterra"],
    moral: ["Ossessione", "Peso del rancore", "Eredità emotiva", "Guarigione"]
  },
  ...
  book3: {
    ...
    narrativeStyles: ["Gotico", "Realistico"],
    topic: ["Conoscenza", "Fede", "Potere", "Eresia", "Libri", "Censura", "Riso"],
    plot: ["Omicidi", "Indagine", "Biblioteca", "Manoscritto", "Inquisizione", "Incendio"],
    protagonists: ["Monaco investigatore", "Novizio", "Bibliotecario", "Inquisitore", "Monaci"],
    characters: ["Guglielmo da Baskerville", "Adso da Melk", "Jorge da Burgos", "Bernardo Gui", "Malachia", "Severino"],
    temporalSetting: ["1327", "Medioevo"],
    geographicSetting: ["Italia"],
    moral: ["Ricerca della verità", "Pericolo del fanatismo", "Libertà della conoscenza", "Ambiguità del potere religioso"]
  },

  book4: {
    title: "Assassinio sull'Orient Express",
    author: "Agatha Christie",
    coverImage: "Assassinio sull’Orient Express.png",
    genres: ["giallo"],
    narrativeStyles: ["Cinematografico", "Minimalista"],
    topic: ["Giustizia", "Colpa", "Vendetta", "Segreti", "Indagine", "Moralità ambigua"],
    plot: ["Delitto in treno", "Passeggeri sospetti", "Alibi", "Interrogatori", "Indizi", "Soluzione collettiva"],
    protagonists: ["Detective", "Assassino", "Vittima", "Passeggeri", "Servitore", "Nobildonna"],
    characters: ["Hercule Poirot", "Samuel Ratchett", "Mary Debenham", "Princesse Dragomiroff", "Colonel Arbuthnot", "Hector MacQueen"],
    temporalSetting: "1930s",
    geographicSetting: "Orient Express",
    moral: ["Giustizia imperfetta", "Responsabilità collettiva", "Limiti della legge", "Verità morale"]
  },
  ...
  book5: {
    ...
    narrativeStyles: ["Epico", "Cinematografico"],
    topic: ["Potere", "Ecologia", "Destino", "Religione", "Colonialismo", "Risorse", "Profezia"],
    plot: ["Tradimento", "Esilio", "Addestramento", "Ribellione", "Controllo"],
    protagonists: ["Giovane erede", "Sacerdotessa", "Imperatore", "Barone"],
    characters: ["Paul Atreides", "Lady Jessica", "Chani", "Duca Leto Atreides", "Barone Harkonnen", "Stilgar"],
    temporalSetting: "Futuro lontano",
    geographicSetting: ["Arrakis", "Pianeta desertico"],
    moral: ["Responsabilità del potere", "Pericolo del messianismo", "Equilibrio ecologico", "Costo della vendetta"]
  },

  book6: {
    title: "Il Signore degli Anelli",
    author: "J.R.R. Tolkien",
    coverImage: "Il Signore degli Anelli.png",
    genres: ["fantasy", "avventura"],
    narrativeStyles: ["Epico", "Lirico"],
    topic: ["Amicizia", "Potere", "Coraggio", "Tentazione", "Bene e male", "Sacrificio", "Nostalgia"],
    plot: ["Compagnia", "Viaggio", "Anello", "Guerra", "Tradimento", "Ritorno a casa"],
    protagonists: ["Hobbit", "Mago", "Re in esilio", "Elfo"],
    characters: ["Frodo Baggins", "Sam Gamgee", "Gandalf", "Aragorn", "Gollum", "Sauron"],
    temporalSetting: ["tempo indeterminato"],
    geographicSetting: ["Terra di Mezzo"],
    moral: ["Forza collettiva", "Fedeltà", "Resistenza alla corruzione", "Speranza contro il male"]
  },

  book7: {
    title: "Harry Potter e la pietra filosofale",
    author: "J.K. Rowling",
    coverImage: "Harry Potter e la pietra filosofale.png",
    genres: ["fantasy", "ragazzi"],
    narrativeStyles: ["Cinematografico", "Realistico"],
    topic: ["Magia", "Amicizia", "Identità", "Scuola", "Famiglia scelta", "Coraggio", "Mistero"],
    plot: ["Orfano", "Poteri magici", "Scuola di magia", "Oggetto magico", "Scontro con il male"],
    protagonists: ["Mago", "Studente", "Amici", "Professori", "Antagonista oscuro"],
    characters: ["Harry Potter", "Hermione Granger", "Ron Weasley", "Albus Silente", "Severus Piton", "Lord Voldemort"],
    temporalSetting: "1990s",
    geographicSetting: ["Regno Unito", "Hogwarts"],
    moral: ["Lealtà", "Coraggio", "Valore dell'amicizia", "Scelta oltre il talento"]
  },

  book8: {
    title: "Into the Wild",
    author: "Jon Krakauer",
    coverImage: "Into the Wild.png",
    genres: ["biografico", "avventura"],
    narrativeStyles: ["Realistico", "Drammatico"],
    topic: ["Liberta", "Natura", "Solitudine", "Famiglia", "Idealismo", "Rifiuto del consumismo", "Rischio"],
    plot: ["Cambiare pagina", "Viaggio", "Incontri", "Sopravvivenza", "Alaska", "Errore fatale"],
    protagonists: ["Giovane viaggiatore", "Famiglia", "Escursionista", "Lavoratore stagionale", "Narratore giornalista"],
    characters: ["Christopher McCandless", "Jon Krakauer", "Walt McCandless", "Billie McCandless", "Wayne Westerberg", "Ron Franz"],
    temporalSetting: "1990s",
    geographicSetting: ["Stati Uniti", "Alaska"],
    moral: ["Fascino e rischio della libertà", "Limiti dell'idealismo", "Bisogno degli altri", "Rispetto della natura"]
  },
